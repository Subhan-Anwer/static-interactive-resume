...
// Remove Menu Mobile
const navLink = document.querySelectorAll('.nav-menu') as NodeListOf<HTMLElement>;
...
const contactMessage = document.getElementById('contact-message') as HTMLParagraphElement;
...
// Show Scroll Up
const scrollUp = () => {
    const scrollUpElement = document.getElementById('scroll-up') as HTMLDivElement;
...
const section = document.querySelectorAll('section[id]') as NodeListOf<HTMLElement>;
...
const scrollActive = () => {
  ...
  section.forEach((current) => {
    ...
    const sectionsClass = document.querySelector('.nav__menu a[href*=' + sectionId + ']') as HTMLAnchorElement;
